 ...
 */
public class Divide<T> extends BinaryOperation<T> implements TripleExpression<T> {

    public Divide(TripleExpression<T> firstOperand, TripleExpression<T> secondOperand, Operation<T> operation) {
